...
st.set_page_config(page_title="Informe sobre la investigació alumnes de l'Aigua",page_icon="✅",layout="wide")
...
st.title("Informe - Parlant amb...Júlia i l'Aigua")
...
# Crea una conexión con la base de datos
        ...
        sql = "SELECT * FROM teclaPREGUNTES WHERE tema = '2025121299'"
        cur.execute(sql)
