...
def disable():
    if nom != '' and nom in l1:
        ...
        if nom in l2:
            especials = "Answer always in spanish.Give short answers, no more than 2 lines,and as if you were explaining it to a 5 year old child. "
        if nom in l3:
            especials3 = "Give short answers, no more than 2 lines,and as if you were explaining it to a 5 year old child and only about art in Ancient Egypt.Find the answer especially in the context of ART IN ANCIENT EGYPT: painting and sculpture."
        if nom in l4:
            especials4 = "Give short answers, no more than 2 lines,and as if you were explaining it to a 5 year old child and gives answers only about writing in Ancient Egypt.Find the answer especially in the context of  EGYPTIAN WRITING: hieroglyphs and alphabet."
        if nom in l5:
            especials5 = "Give short answers, no more than 2 lines,and as if you were explaining it to a 5 year old child and gives answers only about Mummies in Ancient Egypt.Find the answer especially in the context of  Sarcophagi, mummies and mummification."
        if nom in l6:
            especials6 = "Give short answers, no more than 2 lines,and as if you were explaining it to a 5 year old child and gives answers only about believes in Ancient Egypt.Find the answer especially in the context of BELIEFS and objects buried in the pyramids."
        if nom in l7:
