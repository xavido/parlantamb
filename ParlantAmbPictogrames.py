...
l1 = ['xdominguez', 'mqueralto','garte','gescritura','gmomias','gcreencias','gdioses','ILAN','ilan','CHLOE','chloe','gsociedad']
...
def disable():
    if nom != '' and nom in l1:
        ...
        if nom in l3:
            especials3 = "Gives answers only about plants and botanics.Short answer in 1 line and 6 words maximum and always in catalan and repeat the answer in romanian."
        if nom in l4:
            especials4 = "Gives answers only about plants and botanics.Short answer in 1 line and 6 words maximum and always in catalan and repeat the answer in urdu."
        if nom in l5:
            especials5 = "Gives answers only about plants and botanics.Short answer in 1 line and 6 words maximum and always in catalan and repeat the answer in chinese."
        if nom in l6:
            especials6 = "Gives answers only about plants and botanics.Short answer in 1 line and 6 words maximum and always in catalan and repeat the answer in spanish."
        if nom in l7:
            especials7 = "Gives answers only about plants and botanics.Short answer in 1 line and 6 words maximum and always in catalan and repeat the answer in spanish."
        if nom in l8:
            especials8 = "Gives answers only about plants and botanics.Short answer in 1 line and 6 words maximum and always in catalan and repeat the answer in spanish."
    ...
    if stt_user := speech_to_text(language='ca', start_prompt="Fes pregunta amb veu",stop_prompt="Fi de pregunta",use_container_width=True, just_once=True, key='STT'):
        ...
        for message in assistant_messages_for_run:
            ...
            with st.chat_message("assistant"):
                ...
                creaName = str(nom) + "_" + str(time.time()) + "_" + str(2222222) + ".jpg"
        ...
        valores = (nom, prompt, message.content[0].text.value, creaName, 2222222)
