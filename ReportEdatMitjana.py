...
count = 0
st.cache_data.clear()
csv_file_path = 'edat_mitjana_.csv'
...
st.set_page_config(page_title="Informe sobre - Parlant amb Luciana",page_icon="✅",layout="wide")

openai.api_key = st.secrets["auto_pau"]

l1 = ['xdominguez', 'mireia','mavi']
listcaptions =[]
listimages = []
...
st.title("Informe - Parlant amb...Luciana")
...
# Crea una conexión con la base de datos
        ...
        sql = "SELECT * FROM teclaPREGUNTES WHERE tema = '303500'"
        cur.execute(sql)
